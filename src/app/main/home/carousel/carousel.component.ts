...
export class CarouselComponent {
  ...
  public slides = [
    { src: this.fullImagePath2, caption: { text: 'The Christus Victor pre-school children are happy with their new buses.', textLink: 'View Grants Awarded Click Here', link: '/grants-awarded' } },
