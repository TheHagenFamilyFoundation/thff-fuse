...
@Component({
  ...
  styleUrls: ['./organization-doc501c3.component.scss'],
})
export class OrganizationDoc501c3Component implements OnInit {
                      ...
                      (directors) => {
                        ...
                        directors.forEach((director) => {
                          ...
                          this.emailService.sendValidate501c3({
                            ...
                            // <postmaster@sandboxXXXXXXXXXXXXXXXXXXXXX.mailgun.org>',
                            to: director.email,
                              ...
                              directors.forEach((director) => {
                                ...
                                this.emailService.sendValidate501c3({
                                  ...
                                  director: (director.firstName && director.lastName
                                    ? director.firstName : director.username),
                                  orgName: this.org.name,
                                  orgID: this.org.organizationID,
                                })
                                  .subscribe(
  ...
  openDelete501c3Check(): void {
    const dialogRef = this.dialog.open(DeleteDoc501c3CheckComponent, {
      width: '400px',
      data: {},
    });
