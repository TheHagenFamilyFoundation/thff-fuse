...
@Component({
  ...
  styleUrls: ['./organization-full-proposals.component.scss'],
})
export class OrganizationFullProposalsComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog,
    private getFullProposalService: GetFullProposalService,
  ...
  openRouteFPDialog(fp): void {
    const dialogRef = this.dialog.open(OrgSelectedFullProposalComponent, {
      width: '250px',
