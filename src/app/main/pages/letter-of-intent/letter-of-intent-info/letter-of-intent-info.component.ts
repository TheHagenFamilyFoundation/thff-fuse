...
import {
  FormBuilder, FormGroup, FormControl, FormGroupDirective, NgForm, Validators,
} from '@angular/forms';
...
@Component({
  ...
  styleUrls: ['./letter-of-intent-info.component.scss'],
})
export class LetterOfIntentInfoComponent implements OnInit {
  ...
  constructor(
    ...
    if (!environment.production) {
      ...
      console.log('LetterOfIntentInfoComponent - this.API_URL', this.API_URL);
    }
